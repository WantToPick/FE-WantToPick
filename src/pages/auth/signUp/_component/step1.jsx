  ...
  return (
    <div className="step flex flex-col items-center">
      ...
      <div className="flex gap-6">
        <button 
          className="flex flex-col items-center px-4 py-2 bg-gray-100 rounded-2xl hover:bg-gray-200" 
        ...
        >
          ...
          <span className="text-lg font-medium">연습생</span>
        ...
        >
          ...
          <span className="text-lg font-medium">기획사</span>
