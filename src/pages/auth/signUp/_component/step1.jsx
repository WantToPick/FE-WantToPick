  ...
  return (
    <div className="step flex flex-col items-center">
      ...
      <div className="flex gap-6">
        <button 
          className="flex flex-col items-center px-4 py-2 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200" 
        ...
        >
          ...
          <span className="text-sm font-medium">연습생</span>
          <span className="text-xs text-gray-500">기획사에게 PICK 되고 싶어요.</span>
        </button>
        <button 
          className="flex flex-col items-center px-4 py-2 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200" 
        ...
        >
          ...
          <span className="text-sm font-medium">기획사</span>
          <span className="text-xs text-gray-500">연습생을 PICK 하고 싶어요.</span>
        </button>
      </div>
    </div>
  );
